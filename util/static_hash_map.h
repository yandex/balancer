...
struct sthash_mapped_c {
   ...
   TMappedFile M;
   H *hsh;
   sthash_mapped_c() : M(), hsh(0) {}
   sthash_mapped_c(const char *fname, bool precharge) : M(), hsh(0) {
...
struct sthash_mapped : public sthash_mapped_c< sthash<Key, T, Hash> > {
   ...
   sthash_mapped(const char *fname, bool precharge) : sthash_mapped_c<H>(fname, precharge) {}
   sthash_mapped() : sthash_mapped_c<H>() {}
};
