    ...
    struct TLogIniter {                                                             \
        TLogIniter() {                                                              \
            SysLogInstance().ResetBackend(                                          \
                (ident) ?                                                           \
                (TLogBackend*)(new TSysLogBackend((ident), (facility), (flags))) :  \
                (TLogBackend*)(new TNullLogBackend()));                             \
        }                                                                           \
    } JOIN(loginit, __LINE__);
