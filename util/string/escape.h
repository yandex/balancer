...
typename TCharStringTraits<TChar>::TString& EscapeCImpl(const TChar* str, size_t len,
                                                        typename TCharStringTraits<TChar>::TString&);

template <class TChar>
typename TCharStringTraits<TChar>::TString& UnescapeCImpl(const TChar* str, size_t len,
                                                        typename TCharStringTraits<TChar>::TString&);
