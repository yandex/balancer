...
TFileHandle::TFileHandle(const Stroka& fName, ui32 oMode) throw () {
    ...
    Fd_ = ::CreateFile(~fName, faMode, shMode, &secAttrs, fcMode, attrMode, NULL);
...
TFileStat TFile::GetStat() const {
    return TFileStat(*this);
}
