...
SIMPLE_UNIT_TEST_SUITE(TPosixGetoptTest) {
    SIMPLE_UNIT_TEST(TestSimple) {
        ...
        UNIT_ASSERT_VALUES_EQUAL(NLastGetopt::optarg, Stroka("1"));
        UNIT_ASSERT_VALUES_EQUAL('f', NLastGetopt::getopt(argc, argv, "bf:"));
        UNIT_ASSERT_VALUES_EQUAL(NLastGetopt::optarg, Stroka("2"));
    ...
    SIMPLE_UNIT_TEST(TestLong) {
        ...
        UNIT_ASSERT_VALUES_EQUAL('b', NLastGetopt::getopt_long(argc, argv, "bf:", longopts, 0));
        UNIT_ASSERT_VALUES_EQUAL('f', NLastGetopt::getopt_long(argc, argv, "bf:", longopts, &longIndex));
        UNIT_ASSERT_VALUES_EQUAL(1, longIndex);
        UNIT_ASSERT_VALUES_EQUAL('f', NLastGetopt::getopt_long(argc, argv, "bf:", longopts, NULL));
        UNIT_ASSERT_VALUES_EQUAL(0, NLastGetopt::getopt_long(argc, argv, "bf:", longopts, NULL));
        UNIT_ASSERT_VALUES_EQUAL(-1, NLastGetopt::getopt_long(argc, argv, "bf:", longopts, NULL));
    ...
    SIMPLE_UNIT_TEST(TestLongPermutation) {
        ...
        NLastGetopt::optreset = 1;
        UNIT_ASSERT_VALUES_EQUAL('b', NLastGetopt::getopt_long(argc, argv, "bf:", longopts, NULL));
        UNIT_ASSERT_VALUES_EQUAL('b', NLastGetopt::getopt_long(argc, argv, "bf:", longopts, NULL));
        UNIT_ASSERT_VALUES_EQUAL(-1, NLastGetopt::getopt_long(argc, argv, "bf:", longopts, NULL));
    ...
    SIMPLE_UNIT_TEST(TestNoOptionsOptionsWithDoubleDash) {
        ...
        NLastGetopt::optreset = 1;
        UNIT_ASSERT_VALUES_EQUAL('?', NLastGetopt::getopt_long(argc, argv, "bf", longopts, NULL));
    }
    ...
    SIMPLE_UNIT_TEST(TestLongOnly) {
        ...
        NLastGetopt::optreset = 1;
        UNIT_ASSERT_VALUES_EQUAL('F', NLastGetopt::getopt_long_only(argc, argv, "fo", longopts, NULL));
        UNIT_ASSERT_VALUES_EQUAL('F', NLastGetopt::getopt_long_only(argc, argv, "fo", longopts, NULL));
        UNIT_ASSERT_VALUES_EQUAL('f', NLastGetopt::getopt_long_only(argc, argv, "fo", longopts, NULL));
        UNIT_ASSERT_VALUES_EQUAL('o', NLastGetopt::getopt_long_only(argc, argv, "fo", longopts, NULL));
        UNIT_ASSERT_VALUES_EQUAL(-1,  NLastGetopt::getopt_long_only(argc, argv, "fo", longopts, NULL));
    }

    SIMPLE_UNIT_TEST(TestLongWithoutOnlySingleDashNowAllowed) {
        const NLastGetopt::option longopts[] = {
                { "foo",      no_argument,            NULL,           'F' },
                { "zoo",      no_argument,            NULL,           'z' },
                { NULL,       0,                      NULL,           0   }
        };
        ...
        NLastGetopt::optreset = 1;
        UNIT_ASSERT_VALUES_EQUAL('?', NLastGetopt::getopt_long(argc, argv, "z", longopts, NULL));
    }
}
