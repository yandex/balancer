...
class TBufferedSlave {
    public:
        inline TBufferedSlave()
            : TSlave()
        {
        }

        template <class T1>
        inline TBufferedSlave(T1& t1)
            : Slave_(t1)
        {
        }

        template <class T1>
        inline TBufferedSlave(const T1& t1)
            : Slave_(t1)
        {
        }

        template <class T1, class T2>
        inline TBufferedSlave(const T1& t1, const T2& t2)
            : Slave_(t1, t2)
        {
        }

        template <class T1, class T2, class T3>
        inline TBufferedSlave(const T1& t1, const T2& t2, const T3& t3)
            : Slave_(t1, t2, t3)
        {
        }

        template <class T1, class T2, class T3, class T4>
        inline TBufferedSlave(const T1& t1, const T2& t2, const T3& t3, const T4& t4)
            : Slave_(t1, t2, t3, t4)
        {
        }

        template <class T1, class T2, class T3, class T4, class T5>
        inline TBufferedSlave(const T1& t1, const T2& t2, const T3& t3, const T4& t4, const T5& t5)
            : Slave_(t1, t2, t3, t4, t5)
        {
        }

        template <class T1, class T2, class T3, class T4, class T5, class T6>
        inline TBufferedSlave(const T1& t1, const T2& t2, const T3& t3, const T4& t4, const T5& t5, const T6& t6)
            : Slave_(t1, t2, t3, t4, t5, t6)
        {
        }

        template <class T1, class T2>
        inline TBufferedSlave(T1& t1, const T2& t2)
            : Slave_(t1, t2)
        {
        }

        template <class T1, class T2>
        inline TBufferedSlave(const T1& t1, T2& t2)
            : Slave_(t1, t2)
        {
        }

        template <class T1, class T2>
        inline TBufferedSlave(T1& t1, T2& t2)
            : Slave_(t1, t2)
        {
        }
