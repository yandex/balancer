...
{
  static const struct cpu_parse_data pd[137] = {
...
#line 371 "./modules/arch/x86/x86cpu.gperf"
  ...
  static const unsigned char tab[] = {
    125,113,40,0,113,113,0,0,125,113,120,88,0,0,113,0,
    7,22,0,0,0,7,0,125,113,0,113,125,0,0,0,113,
    113,0,0,0,7,7,125,125,0,125,7,0,82,0,0,0,
    229,0,0,0,0,124,0,113,0,27,0,125,0,0,0,0,
    113,113,113,0,0,235,120,0,27,0,0,0,0,0,0,0,
    173,116,0,0,0,0,7,0,0,22,0,0,240,0,113,113,
    0,77,125,124,101,113,0,0,220,0,145,116,113,61,0,131,
    0,125,132,0,42,0,0,0,186,82,0,39,116,0,0,0,
  };

  const struct cpu_parse_data *ret;
  unsigned long rsl, val = phash_lookup(key, len, 0xdaa66d2bUL);
  rsl = ((val>>25)^tab[val&0x7f]);
  if (rsl >= 137) return NULL;
  ret = &pd[rsl];
