/* $Id: mkpar.c,v 1.1 2007-11-29 19:12:16 pg Exp $ */
...
static void total_conflicts(void)
{
    /* do not warn if encountered number of shift/reduce conflicts was expected */
    if (SRexpect != -1 && SRexpect == SRtotal && RRtotal == 0)
        return;
